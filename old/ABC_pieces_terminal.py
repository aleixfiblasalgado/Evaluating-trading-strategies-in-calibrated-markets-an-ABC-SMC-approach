...
if __name__ == "__main__":
    ...
    # abc = pyabc.ABCSMC(rmsc03, prior, distance,  population_size=pop_size, 
                       # transitions=transition, sampler = pyabc.sampler.MulticoreEvalParallelSampler(n_procs=64), 
                       # max_nr_recorded_particles = 1000)
    ...
    abc.new(pyabc.create_sqlite_db_id(dir_=db_path, file_='proof_of_concept.db'), data)
