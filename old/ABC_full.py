...
if __name__ == "__main__":
    ...
    datapath = os.path.join(os.getcwd(), "MSc_thesis/ABCSMC_Calibration/ABC_output")
    
    abc.new(pyabc.create_sqlite_db_id(dir_= os.getcwd(), file_='proof_of_concept_all.db'), data)
    
    epsilon = 0.001
    
    history1 = abc.run(max_nr_populations=7, minimum_epsilon=epsilon)