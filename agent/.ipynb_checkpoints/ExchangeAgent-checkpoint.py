...
class ExchangeAgent(FinancialAgent):
  ...
  def __init__(self, id, name, type, mkt_open, mkt_close, symbols, book_freq='S', wide_book=True, pipeline_delay = 40000,
  ...
  def kernelTerminating (self):
    ...
    ## Return fundamental time series if wanted
    ...
    if self.book_freq is None: return
      ...
      for symbol in self.order_books:
        ...
        LOB = self.logOrderBookSnapshots(symbol)
